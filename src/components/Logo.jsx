...
const Logo = () => {
    ...
    useEffect(() => {
        ...
        window.addEventListener('resize', a.resize.bind(a));
    
        return () => {
          window.removeEventListener('resize', a.resize.bind(a));
        };
      }, []);
    
      return <canvas style={{ position: 'absolute', top: 0, left: 0, zIndex: -1 }} />;
    };
